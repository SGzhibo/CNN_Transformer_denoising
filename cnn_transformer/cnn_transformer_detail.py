...
class CnnEncoder(nn.Module):
    def __init__(self):
        ...
        out_channels=[96*2**(i) for i in range(4)]
        self.d0 = DownsampleLayer(1, out_channels[0])
        self.d1=DownsampleLayer(out_channels[0],out_channels[1])
...
class DecoderBlock(nn.Module):
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            DPTB(dim=dim, input_resolution=input_resolution,
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=1,
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer ==0 :
                ...
                layer_up = DecoderBlock(dim=int(embed_dim * 2 ** (self.num_layers-1-i_layer)),
